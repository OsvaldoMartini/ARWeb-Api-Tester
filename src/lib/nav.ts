...
/**
 * The main navigation destinations. This is the single source of truth for
 * the Sidebar and Home quick-action cards.
 */
export const NAV_ITEMS: NavItem[] = [
  ...
  { path: '/scripts', label: 'Scripts', description: 'Create Bash curl scripts from saved BotJobs.', icon: Terminal },
