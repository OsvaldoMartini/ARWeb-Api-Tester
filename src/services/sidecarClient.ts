...
export interface BotJobBashExport {
  fileName: string;
  content: string;
  apiCallCount: number;
  botJobId: string;
...
export const sidecar = {
  ...
  exportBotJobBash: (id: string, environmentId: string) =>
    request<BotJobBashExport>(
      `/botjobs/${id}/export/bash?environmentId=${encodeURIComponent(environmentId)}`,
    ),
